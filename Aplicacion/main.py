...
if Choice == 1:
	...
	Total += algoritmos.Imprimir_y_Anadir(Max, Total, 6, driver, "DIA atun claro en aceite de oliva contenido bajo en sal pack 3 latas 156gr")
	...
	Total += algoritmos.Imprimir_y_Anadir(Max, Total, 5, driver, "DIA agua natural 1.5l")
	Total += algoritmos.Imprimir_y_Anadir(Max, Total, 3, driver, "DIA barra pan")
	Total += algoritmos.Imprimir_y_Anadir(Max, Total, 2, driver, "DIA macarron paquete")
	Total += algoritmos.Imprimir_y_Anadir(Max, Total, 10, driver, "DIA refresco cola")
